export const pages = [
    [
        ...
        "We will begin with the absolute basics and build our knowledge up. Each module will introduce a single new concept, and you will be provided with a full lesson and unlimited amount of practice exercises to learn that new concept.",
        "This course will begin with simple arithmetic, and will gradually escalate up to multivariable calculus, linear algebra, and differential equations. It will be a long journey, but with a little time, effort and determination, you'll be a mathematics professional before you know it!",
